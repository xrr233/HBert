...
def construct_pointwise_examples(examples,chunk_indexs,max_seq_len,mlm,bert_tokenizer,masked_lm_prob,
	...
	with DocumentDatabase(reduce_memory=args.reduce_memory) as docs:
		...
		for epoch in range(args.epochs_to_generate):
			...
			for i in range(num_processors):
				...
				# print("?")
				r = processors.apply_async(construct_pointwise_examples, (docs, chunk_indexs, args.max_seq_len, args.mlm, bert_tokenizer, args.masked_lm_prob, \

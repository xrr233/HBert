...
print("===============================")
os.system(
          f'python -m torch.distributed.launch  --nproc_per_node=8 --nnodes=4 --node_rank={int(RANK)}  /home/work/user-job-dir/Pretrain/run_mlm_my.py \
        --fp16 \
...
mox.file.copy_parallel("/home/work/user-job-dir/Pretrain/experiment/","s3://obs-app-2020042019121301221/SEaaKM/g50020960/code/Pretrain/experiment/")

...
#from models.NewBertModel import HirachicalBert
from models.modeling_html import HirachicalBert
import sys
...
from mydatasets import BERTPretrainedPointWiseDataset,PointCollator,HBERTPointCollator,HBERTPretrainedPointWiseDataset
...
def main():
    ...
    if model_args.model_name_or_path:
        ...
        model = HirachicalBert.from_pretrained(
        ...
        model = HirachicalBert(node_config=node_config,text_config=text_config,layer_num=5)
